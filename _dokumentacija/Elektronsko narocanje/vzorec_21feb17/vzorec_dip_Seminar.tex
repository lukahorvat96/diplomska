...
Najprej smo izdelali podatkovno bazo katero fizično obliko lahko vidite na sliki~\ref{Database_physical}. Sestavljena je iz šestih tabel katere so bolj podrobno opisane spodaj.

\begin{figure}[!htb]
\begin{center}
\includegraphics[width=0.5\textwidth]{Database_physical}
\end{center}
