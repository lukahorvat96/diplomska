...
\begin{figure}[!htb]
\centering
\includegraphics[width=13.2cm]{customer_1.jpg}
...
\caption{Pojavno sporočilo ob natakarjevi zavrnitvi naročila}
\label{Gost_8}
\end{figure}
\begin{figure}[!htb]
\centering
